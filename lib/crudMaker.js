 ...
 *
 * @typedef {Array<'create'| 'get' |  'getall' | 'update' | 'delete' | 'count' | 'list' | 'status'>} methods
 ...
 * @property {[key:'create'| 'get' |  'getall' | 'update' | 'delete' | 'count' | 'list' | 'status' ]:object} methodsDef
 *
